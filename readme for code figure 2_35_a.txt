##########################################################################
# ---------------------------------------------------------------------------------------------------------------------
# This is MATLAB code to produce IPCC AR6 WGI Figure 2.35, panel a
# Creator: Juan A. Rivera, IANIGLA/CONICET 
# Contact: jrivera@mendoza-conicet.gob.ar
# Last updated on: July 8th, 2021
# --------------------------------------------------------------------------------------------------------------------
#
# - Code functionality: sam_index_panel_a.m: This code plots the time series of reconstructed SAM variability for the period 1000-2004 for a variety of datasets
# - Input data: MATLAB file of SAM reconstructions from a variety of datasets. The file can be accessed at: *Link to CEDA catalogue*
# - Output variables: The code plots figure 2.35 panel a as in the report
#
# ----------------------------------------------------------------------------------------------------
