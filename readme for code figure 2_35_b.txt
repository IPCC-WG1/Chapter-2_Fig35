##########################################################################
# ---------------------------------------------------------------------------------------------------------------------
# This is MATLAB code to produce IPCC AR6 WGI Figure 2.35, panel b
# Creator: Juan A. Rivera, IANIGLA/CONICET 
# Contact: jrivera@mendoza-conicet.gob.ar
# Last updated on: July 8th, 2021
# --------------------------------------------------------------------------------------------------------------------
#
# - Code functionality: sam_index_panel_b.m: This code plots the time series of observed SAM variability for the period 1900-2019 for a variety of datasets
# - Input data: MATLAB file of observed SAM indices from a variety of datasets. The file can be accessed at: *Link to CEDA catalogue*
# - Output variables: The code plots figure 2.35 panel b as in the report
#
# ----------------------------------------------------------------------------------------------------
